...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      {...props}>
      {isDark ? <Sun className={`${isDark ? 'rotate-0 scale-100 opacity-100' : '-rotate-90 scale-0 opacity-0 absolute'}  transition-all `} /> : <Moon className={`${!isDark ? 'rotate-0 scale-100 opacity-100' : 'rotate-90 scale-0 opacity-0 absolute'}  transition-all  `} />}
